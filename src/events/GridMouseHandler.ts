...
export class GridMouseHandler 
{
    ...
    constructor(
        ...
        this.hitChecks = [
            ...
            new ColumnSelectionHandler(this.columnSelection, this.cellRangeSelection, this.viewport),
            new RowSelectionHandlers(this.rowSelection, this.cellRangeSelection, this.viewport),
            new CellSelectionHandler(this.cellSelection, this.cellRangeSelection)
        ];
    }
